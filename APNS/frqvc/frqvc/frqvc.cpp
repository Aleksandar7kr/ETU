...
// frqvc.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CfrqvcApp, CWinApp)
...
// Единственный объект CfrqvcApp

CfrqvcApp theApp;


// инициализация CfrqvcApp

BOOL CfrqvcApp::InitInstance()
{
