...
namespace Kruskal
{
    class Matrix2d
    {
        ...
        /// <summary>
        /// Set random values for all elements of matrix
        /// </summary>
        ...
        public double MaxValueAtColumn(int index)
        {
            double max = Double.NegativeInfinity;

            for (int i = 0; i < YSize; i++)
            {
                max = Math.Max(max, this[index,i]);
            }

            return max;
        }

        public double MaxValueAtRow(int index)
        {
            double max = Double.NegativeInfinity;

            for (int i = 0; i < XSize; i++)
            {
                max = Math.Max(max, this[i,index]);
            }
